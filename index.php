...
<head>
    ...
    <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Bungee%20Inline:100,200,400,600">
    ...
    <script src="http://localhost:8088/AboutMe/js/jquery-3.3.1.js"></script>
...
<nav class="navbar navbar-inverse">
  ...
  <footer class="main-footer footer-landpage">
    ...
    <div class="about"></div>
    <div class="about-text">Seja bem vindo ao meu portfolio!</div>
