...
<head>
    ...
    <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Fanwood%20Text:100,200,400,600">
...
<body class="back-page-portfolio">
<nav class="navbar navbar-inverse">
  ...
  <footer class="main-footer footer-landpage">
    ...
    <div class="ptext">Atualmente, não tenho nenhum trabalho concluído! <br>:(<br> <br>Porém, estarei atualizando
    este portfolio conforme for concluindo! :)</div>
