...
<nav class="navbar navbar-inverse">
  ...
  <footer class="main-footer footer-landpage">
    ...
    <div class="mtext">Nesta seção, deixarei o link para o SoundCloud da minha banda:<br><span class="rotten">Rotten Pieces</span></div>
    <div class="link">https://soundcloud.com/rotten-pieces-official</div>
